...
enum AnimalEnum {
    ...
    case identifiableAnimal(Identifiable)
}
...
/// enum conforms Identifiable protocol
extension HttpError: Identifiable {
    // implementation of property
    var id: String {
...
struct Human: Identifiable, NameProviding, Animals {
    var id: String {
        UUID().uuidString
    }
...
let abstractedObject = createIdentifiable()
...
typealias NamedAnimal = Animals & Identifiable & NameProviding
